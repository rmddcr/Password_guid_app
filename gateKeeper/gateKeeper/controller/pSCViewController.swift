...
class pSCViewController: UIViewController {
    ...
    func setup_UI(){
        ...
        let gestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(pSCViewController.tapButton(sender:)))
...
extension pSCViewController : UITextFieldDelegate {
